...
public class GeoSegmentTest {
	...
	public void show(String str, boolean ok) {
  	...
  	public void test() {
		...
		show("getLength()");
		show("East 1 km " + gsEast.getLength(), same(gsEast.getLength(),1.0));
		show("West 1 km " + gsWest.getLength(), same(gsWest.getLength(),1.0));
		show("North 1 km " + gsNorth.getLength(), same(gsNorth.getLength(),1.0));
		show("1.414 km", same(gsDiag.getLength(),1.414));
		
		show("getHeading()");
		show("East should be 90 == " + gsEast.getHeading(), same(gsEast.getHeading(), 90.0));
		show("West should be 270 == " + gsWest.getHeading(), same(gsWest.getHeading(), 270.0));
